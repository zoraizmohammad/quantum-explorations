// Solutions for Lab 3: Complex Superpositions
// Copyright 2021 The MITRE Corporation. All Rights Reserved.

namespace QSharpExercises.Solutions.Lab3 {
    ...
    operation Exercise3 (register : Qubit[], target: Qubit) : Unit {
        ...
        //    + |000,0> + |001,0> + |010,0> + |011,0>) (same; this does nothing)

        // X(register[1]);
        // 1/√8(|010,0> + |011,0> + |000,0> + |001,0>
        //    + |110,0> + |111,0> + |100,0> + |101,0>) (same; this does nothing)
    ...
    operation Exercise5 (register : Qubit[]) : Unit {
        ...
        // X(register[2]);
        // 1/√8(|001,1> + |000,1> + |011,1> + |010,1>
        //    + |101,1> + |100,1> + |111,1> + |110,1>) (technically not needed)

        Controlled Z(register, ancilla);
        // 1/√8(|001,1> + |000,1> + |011,1> + |010,1>
        //    + |101,1> + |100,1> - |111,1> + |110,1>)
